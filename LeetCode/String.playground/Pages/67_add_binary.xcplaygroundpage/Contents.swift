/*:
 ...
 Simulate binary addition as how a human would do it.
 
 - **Time Complexity**: _O(n + m)_, where n is the length of a and m is the length of m
 - **Space Complexity**: _O(n + m)_, where n is the length of a and m is the length of m
